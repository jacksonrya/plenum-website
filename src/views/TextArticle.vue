        ...
        <article>
            ...
            >
                ...
                <div class="article__body">
                    <section
                        v-for="(section, index) in article.article_section || article.body"
...
export default {
    ...
    methods: {
         ...
         * @return {string}
         */
        getImageSource: function(fileName) {
         ...
         * @param {Event} e
         */
        handleArticlePageInView: function(e) {
            // If at top of page
    ...
    computed: {
         ...
         * @return {string} e.g. 'McClung J.' for a single author or 'Deremer, E. et al.' for multiple authors.
         */
        authorCopyrightFormat: function() {
